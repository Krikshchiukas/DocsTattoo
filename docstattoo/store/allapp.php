...
if ($apparel != null){	
	...
	echo "<table class = \"content\"><tr><td class = \"concell\"><form action = \"cartup.php\" method = \"POST\">";
	echo"<img src=images/".$imagecode." alt=".$imagecode."class = \"conpic\">";
	echo "</td>";
	echo "<td class = \"concell\"><table><tr><td class = \"concell\">".$inst->name."</td><td class = \"concell\"><input type=\"submit\" class = \"cart\" value=\"add to cart\"></td></tr>";
	echo "<tr><td class = \"concell\">Shape: ".$inst->shape."</td><td class = \"concell\">£ ".$inst->price."</td></tr>";
	echo "<tr><td class = \"concell\">Sized at: ".$inst->size."</td><td class = \"concell\"> <input type=\"number\" name=\"quantity\" min=\"1\" max=\"9\"></td></tr></table></td></tr>";
