...
$sql2 = "INSERT INTO styles (`style_ID`, `style_name`, `shape`, `type`, `coil_ID`) VALUES (".$style_ID.", '".$name."', '".$shape."', '".$type."', ".$coil_ID.");";
$sql3 = "INSERT INTO machine (`machine_ID`, `contact`, `saddle`, `magnet`, `capacitor`, `material`, `thumb_screw`, `springs`, `colour_ID`, `style_ID`) 
VALUES (".$machine_ID.", '".$contact."', '".$saddle."', '".$magnet."', '".$capacitor."', '".$material."', '".$thumb."', '".$springs."', ".$colour_ID.", ".$style_ID.")";
$sql4 = "INSERT INTO `product` (`product_ID`, `price`, `stock`, `machine_ID`, `apparel_ID`, `legacy`) VALUES (".$product_ID.", '".$price."', '".$stock."', ".$machine_ID.", NULL, '0')";
