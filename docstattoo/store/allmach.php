...
if ($machines != null){	
	...
	echo "</td>";
	echo "<td class = \"concell\"><table><tr><td>".$inst->style_name."</td><td class = \"concell\"><input type=\"submit\" class = \"cart\" value=\"add to cart\"></td></tr>";
	echo "<tr><td class = \"concell\">".$inst->type." with a ".$inst->shape." shape</td><td class = \"concell\">£ ".$inst->price."</td></tr>";
	echo "<tr><td class = \"concell\">Made from: ".$inst->material."</td><td class = \"concell\"d> <input type=\"number\" name=\"quantity\" min=\"1\" max=\"9\"></td></tr></table></td></tr>";
